...
export function JobQueueTable({
  ...
  // ⚡ Bolt Optimization: Memoize the sorted jobs list.
  // This avoids re-running the O(N log N) sorting logic on every re-render
  // (for instance, when selectedJobId or busyId changes).
