...
| Post-v0.1 work (Steps 1–6) | `docs/steps/TRACKER.md`, `AGENT_PROGRESS.md` |
| Log prescan/UI defects (before Step 5) | `docs/steps/STABILIZATION_BACKLOG.md` § Execution path S01–S09 |
