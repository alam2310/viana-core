...
| **Human API summary** | `api_contracts.md` | Must match schemas |
| **Class names & aggregation flags** | `configs/classes.yaml` | Inference time |
| **UVH training label map** | `configs/vehicle_taxonomy.json` | Training / legacy only |
...
| **Historical research** | `blueprint.md` | **Not** current status |
...
- `docs/ITVA Environment Setup Guide.md` — training paths updated to `legacy/training/`
